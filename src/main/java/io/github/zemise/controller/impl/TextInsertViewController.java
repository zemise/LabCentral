...
import io.github.zemise.services.Dele;
import io.github.zemise.util.FileUtil;
...
import static io.github.zemise.util.TextInTIFF.getImageFile;
import static io.github.zemise.util.TextInTIFF.insertText;
 ...
 * @since 2023/7/21
 */
public class TextInsertViewController implements Initializable {
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        textArea.setText(FileUtil.read());
